...
export default function Home() {
  return (
    <main>
      ...
      <section className="work section" id="work"><div className="sectionHead"><div><p className="sectionLabel">02 / SELECTED WORK</p><h2>Proof, not just<br/>possibility.</h2></div><p>Four connected projects from one internship—showing a progression from understanding risk and operations to building a working decision-support platform.</p></div>
      ...
      <section className="experience section" id="experience"><p className="sectionLabel">03 / EXPERIENCE</p><div className="experienceGrid"><div><p className="period">2026</p><h2>Industrial Belt<br/>Technology</h2><p className="experienceRole">Cybersecurity / IT Internship</p></div><div className="progression">{["Incident recovery & continuity", "Security audit & risk", "Network & security operations", "AI-assisted network analytics"].map((item, i) => <div key={item}><span>0{i + 1}</span><p>{item}</p><i>{i === 3 ? "BUILD" : "LEARN → APPLY"}</i></div>)}</div></div></section>
      ...
      <section className="education section"><p className="sectionLabel">05 / EDUCATION</p><div><p className="degree">Computer Science</p><h2>Kent State University</h2><p>Building a foundation in computer science while developing practical experience across software, cybersecurity, networks, and automation.</p></div></section>
