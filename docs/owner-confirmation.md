...
- Exact degree wording used by Kent State University (the site currently says “Computer Science,” not an unverified degree title).
- Internship start/end dates; only the supplied year, 2026, is shown.
